	...
	<header>
		<div class="nav" id="nav">
			...
			<ul id="list-switch">
				...
				<li><a href="computer_courses.jsp"><img src="../images/courses/computer.png" class="icon">Computer Courses</a></li>
				<li><a href="computer_courses.jsp#data"><img src="../images/courses/data.png" class="icon">Data Structures</a></li>
				<li><a href="computer_courses.jspl#algo"><img src="../images/courses/algo.png" class="icon">Algorithm</a></li>
				<li><a href="computer_courses.jsp#projects"><img src="../images/courses/projects.png" class="icon">Projects</a></li>
			</ul>
...
<!-- Main Title of the Page -->
	<div class="title">
		...
		<div class="shortdesc">
			<p>Learn from e-learning for better higher studies in<br> Indian Institutes of Technologies(IIT)</p>
		</div>
	</div>
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			...
			<p class="rights-text">Copyright © 2022 Created By Kapish Bhardwaj, Ajay Kumar, <br> Mausam Tewatia, Shivam Malhotra All Rights Reserved.</p>
			<br><p><img src="../images/icon/location.png"> Cognizant Technology Solutions</p><br>
			<p><img src="../images/icon/phone.png"> +91-1234-567-890<br><img src="../images/icon/mail.png">&nbsp; elearning658@gmail.com</p>
		</div>
		<div class="right-col">
