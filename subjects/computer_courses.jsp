...
<html>
<head>
	<link rel="shortcut icon" type="png" href="../images/icon/favicon1-cp.png">
...
<!-- NAVIGATION -->
	<header>
		<div class="nav" id="nav">
			<div id="learned-logo">
			<a href="../index.jsp"><img src="../images/icon/e-learning.png" style="width: 170px;"></a></div>
			<div class="switch-tab" id="switch-tab" onclick="switchTAB()"><img src="../images/icon/menu.png"></div>
			<ul id="list-switch">
				<li><a href="jee.jsp"><img src="../images/courses/d1.png" class="icon">JEE</a></li>
				<li><a href="gate.jsp"><img src="../images/courses/paper.png" class="icon">GATE</a></li>
...
<!-- PROJECTS -->
	<div class="title2" id="projects">
		...
		<div class="shortdesc2">
			<p>Here you can find various Projects related to Web Deveopment, AI, Java Projects, C++ etc</p>
		</div>
	</div>
	<div class="project-panel">
		<div class="project-card">
			...
			<div class="info">
				...
				<div class="download"><a href="https://projectgurukul.org/java-library-management-system/" target="_blank">Download</a></div>	
			</div>
		</div>
		<div class="project-card">
			<img src="../images/projects/c++.png">
			<div class="info">
				<h4>C++ Project Ideas</h4><p>Top 20 C++ Projects With Source Code</p>
				<div class="download"><a href="https://www.interviewbit.com/blog/cpp-projects/" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			...
			<div class="info">
				...
				<div class="download"><a href="https://data-flair.training/blogs/javascript-project-photo-gallery/" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			...
			<div class="info">
				...
				<div class="download"><a href="https://www.codewithharry.com/videos/web-development-in-hindi-26" target="_blank">Download</a></div>
			</div>
		</div>
		<div class="project-card">
			<img src="../images/projects/ml.jpeg">
			<div class="info">
				<h4>ML Project Ideas</h4><p>Top 47 Machine Learning Project ideas for beginners, intermediates, and experts to gain real-world experience of this growing technology in 2022.</p>
				<div class="download"><a href="https://data-flair.training/blogs/machine-learning-project-ideas/" target="_blank">Download</a></div>
			</div>
		</div>
...
<footer>
	<div class="footer-container">
		<div class="left-col">
			<img src="../images/icon/e-learning-cp.png" style="width: 200px;">
			<div class="logo"></div>
			...
			<p class="rights-text">Copyright © 2022 Created By Kapish Bhardwaj, Ajay Kumar, <br> Mausam Tewatia, All Rights Reserved.</p>
			<br><p><img src="../images/icon/location.png"> Cognizant Technology Solutions</p><br>
			<p><img src="../images/icon/phone.png"> +91-1234-567-890<br><img src="../images/icon/mail.png">&nbsp; elearning6@gmail.com</p>
		</div>
		<div class="right-col">
